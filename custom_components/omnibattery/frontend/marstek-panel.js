...
const I18N = {
  ...
  ca: {
    ...
    secExcluded: "Dispositius exclosos", itemExcludedDevice: "Dispositiu exclòs", itemSolarSurplus: "Excedent solar", itemCoverHome: "Cobrir la llar", itemExclusionPct: "% exclòs",
